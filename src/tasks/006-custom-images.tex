...
\begin{document}
    ...
    \section{Intro}
    Immer wieder wird unter dem Begriff Golden Image oder Custom Image verlangt ein geändertes Linux-Image zu deployen.
    In dieser Challenge können Sie das nötige Vorgehen üben.

    \section{Lernziele}
    Sie lernen ein eigenes minimales Linux ISO zu erstellen.
    ...
    Wie groß ist der Linux Kernel selbst? Warum unterscheiden sich die Angaben, die Sie dazu finden können?
    ...
    Verifizieren Sie Ihre Änderung, indem Sie die Hashwerte Ihres Images mit dem Ausgangsimage vergleichen.
    ...
    Das Image sollte eine Größe von 2 MB nicht übersteigen. TIPP: Es ist möglich ein Linuxsystem von einer Floppy-Disk zu booten.
    ...
    Entwicklen Sie einen Use-Case, erstellen Sie ein passendes Image und deployen Sie es auf geeigneter Infrastruktur.
\end{document}