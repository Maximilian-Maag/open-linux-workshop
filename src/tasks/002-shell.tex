...
\begin{document}
    ...
    \section{Intro}
    Egal ob Server oder Desktop, die Shell ist unter Linux das Standardinstrument für
    ...
    \section{Lernziele}
    Sie lernen die Shell zu bedienen. Nutzen Sie die Shell als Schweizer Taschenmesser für die Interaktion jeder beliebigen Linux Distro.
    ...
    Nutzen Sie eine Pipe und ein Output-Redirect, um das Ergebnis von ls -l /etc in eine Textdatei in ihrem Home-Verzeichnis zu schreiben.

    \subsection{Aufgabe 4}
    Öffnen Sie das Verzeichnis /var/log und geben Sie das das Ergebnis von PWD aus. \\
    ...
    Fügen Sie eine Option zu ihrem Programm hinzu, wird es mit --24h aufgerufen muss die Ausgabe z.B. 14:30 Uhr ausgeben. \\
